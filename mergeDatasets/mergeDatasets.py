...
df_A = pd.read_csv(os.path.join(os.pardir, "experimentFolder/experiment1/application_metrics.csv"),parse_dates={'datetime':['timestamp']})
# Dataset B - 1sec granularity
df_B = pd.read_csv(os.path.join(os.pardir, "experimentFolder/experiment1/system_metrics.csv"), parse_dates={'datetime':['timestamp']})
...
df.to_csv(os.path.join(os.pardir, "experimentFolder/experiment1/merged_system_application_metrics.csv"))